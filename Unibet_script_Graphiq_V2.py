...
jeux = [
    [" TYPE       ", "Nbr Games ", "X2Win ", "X3Win ", "X5Win ", "X10Win ", "X10Lost ", "X25Win ", "X100 ", "X1000 ","ITM ","Net chips/Game ","ROI sans RB "," Gains Nets  ","   Rake  "," RB " + str(Tx_RB)+"% ", "Tps de Jeu "," Games/Hr ", "TxHr avec RB"]
]
